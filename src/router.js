    ...
    children: [
      ...
      },
      {
        path: '/', component: LayoutIndex, children: [
          ...
          { path: '/Course', name: 'Course', component: CourseIndex, meta: { title: i18n.t('router.Course'), createLink: 'CourseCreate'} },
          ...
          { path: '/Department', name: 'Department', component: DepartmentIndex, meta: { title: i18n.t('router.Department'), createLink: 'DepartmentCreate'} },
          ...
          { path: '/ProgramOutcome', name: 'ProgramOutcome', component: ProgramOutcomeIndex, meta: { title: i18n.t('router.ProgramOutcome'), createLink: 'ProgramOutcomeCreate'} },
          { path: '/Popco', name: 'Popco', component: PopcoIndex, meta: { title: i18n.t('router.Popco'), createLink: 'PopcoCreate'} },
          { path: '/Section', name: 'Section', component: SectionIndex, meta: { title: i18n.t('router.Section'), createLink: 'SectionCreate'} },
          ...
          { path: '/Sts', name: 'Sts', component: StsIndex, meta: { title: i18n.t('router.Sts'), createLink: 'StsCreate'} },
