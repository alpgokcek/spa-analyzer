    ...
    children: [
      ...
      },
      {
        path: '/Update', component: LayoutUpdate, children: [
          { path: 'Authority/:param', name: 'AuthorityUpdate', component: AuthorityUpdate, meta: { title: i18n.t('router.AuthorityUpdate') } },
          { path: 'Course/:param', name: 'CourseUpdate', component: CourseUpdate, meta: { title: i18n.t('router.CourseUpdate') } },
          { path: 'CourseOutcome/:param', name: 'CourseOutcomeUpdate', component: CourseOutcomeUpdate, meta: { title: i18n.t('router.CourseOutcomeUpdate') } },
          { path: 'Assessment/:param', name: 'AssessmentUpdate', component: AssessmentUpdate, meta: { title: i18n.t('router.AssessmentUpdate') } },
          { path: 'Department/:param', name: 'DepartmentUpdate', component: DepartmentUpdate, meta: { title: i18n.t('router.DepartmentUpdate') } },
          { path: 'DepartmentsHasInstructors/:param', name: 'DepartmentsHasInstructorsUpdate', component: DepartmentsHasInstructorsUpdate, meta: { title: i18n.t('router.DepartmentsHasInstructorsUpdate') } },
          { path: 'Faculty/:param', name: 'FacultyUpdate', component: FacultyUpdate, meta: { title: i18n.t('router.FacultyUpdate') } },
          { path: 'GradingTool/:param', name: 'GradingToolUpdate', component: GradingToolUpdate, meta: { title: i18n.t('router.GradingToolUpdate') } },
          { path: 'Gtcco/:param', name: 'GtccoUpdate', component: GtccoUpdate, meta: { title: i18n.t('router.GtccoUpdate') } },
          { path: 'Igs/:param', name: 'IgsUpdate', component: IgsUpdate, meta: { title: i18n.t('router.IgsUpdate') } },
          { path: 'Log/:param', name: 'LogUpdate', component: LogUpdate, meta: { title: i18n.t('router.LogUpdate') } },
          { path: 'ProgramOutcome/:param', name: 'ProgramOutcomeUpdate', component: ProgramOutcomeUpdate, meta: { title: i18n.t('router.ProgramOutcomeUpdate') } },
          { path: 'Popco/:param', name: 'PopcoUpdate', component: PopcoUpdate, meta: { title: i18n.t('router.PopcoUpdate') } },
          { path: 'Section/:param', name: 'SectionUpdate', component: SectionUpdate, meta: { title: i18n.t('router.SectionUpdate') } },
          { path: 'Sagt/:param', name: 'SagtUpdate', component: SagtUpdate, meta: { title: i18n.t('router.SagtUpdate') } },
          { path: 'Sgmgco/:param', name: 'SgmgcoUpdate', component: SgmgcoUpdate, meta: { title: i18n.t('router.SgmgcoUpdate') } },
          { path: 'Sgmgpo/:param', name: 'SgmgpoUpdate', component: SgmgpoUpdate, meta: { title: i18n.t('router.SgmgpoUpdate') } },
          { path: 'Sts/:param', name: 'StsUpdate', component: StsUpdate, meta: { title: i18n.t('router.StsUpdate') } },
          { path: 'University/:param', name: 'UniversityUpdate', component: UniversityUpdate, meta: { title: i18n.t('router.UniversityUpdate') } },
          { path: 'User/:param', name: 'UserUpdate', component: UserUpdate, meta: { title: i18n.t('router.UserUpdate') } },
          { path: 'UsersAdmin/:param', name: 'UsersAdminUpdate', component: UsersAdminUpdate, meta: { title: i18n.t('router.UsersAdminUpdate') } },
          { path: 'UsersStudent/:param', name: 'UsersStudentUpdate', component: UsersStudentUpdate, meta: { title: i18n.t('router.UsersStudentUpdate') } },
          { path: 'UsersInstructor/:param', name: 'UsersInstructorUpdate', component: UsersInstructorUpdate, meta: { title: i18n.t('router.UsersInstructorUpdate') } },
          { path: 'CheckAuth/:param', name: 'CheckAuthUpdate', component: CheckAuthUpdate, meta: { title: i18n.t('router.CheckAuthUpdate') } }
        ]
      }
    ]
  },
