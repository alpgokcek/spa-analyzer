    ...
    <b-row class="asc__insertPage-body">
      <b-col cols="12" sm="12" md="12" lg="4" xl="3" class="mb-3">
        <b-card :title="$t('Tariff.general')" class="shadow">
          <b-form-group :label="$t('Tariff.brand')" :class="$v.form.brand.$error && !$v.form.brand.required ? 'form-group--error' : ''">
  ...
  methods: {
    ...
    submitTariff () {
      let datas = {
        ...
        slug: this.form.title + '-' + this.brandName
      }
      this.$store.dispatch('createData', {...this.data, api: 'tariff', info: datas, turn: 'Tariff', retcount: 0})
    },
    brands (e) {
