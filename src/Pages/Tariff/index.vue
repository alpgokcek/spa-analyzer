  ...
  <DxDataGrid
    ...
    <template #operationCell="cell">
      <div class="asc__listPage-operations">
        ...
        <router-link :to="{name: 'TariffUpdate', params: {slug: cell.data.value}}" v-b-tooltip.hover :title="$t('list.setttings')"><i class="fas fa-cog"></i></router-link>
      </div>
    </template>
  ...
  data () {
    return {
      ...
      rows: [
        ...
        {field: 'talk', caption: 'talk', format: '', dataType: '', alignment: 'right', cellTemplate: ''},
        {field: 'internet', caption: 'internet', format: '', dataType: '', alignment: 'right', cellTemplate: ''},
        {field: 'sms', caption: 'sms', format: '', dataType: '', alignment: 'right', cellTemplate: ''},
        {field: 'europe', caption: 'europe', format: '', dataType: '', alignment: 'right', cellTemplate: ''},
