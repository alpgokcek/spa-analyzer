      ...
      <b-col cols="12" sm="12" md="12" lg="8" xl="9" class="mb-3">
        <b-card class="asc__insertPage-card-withTab shadow">
          <b-tabs content-class="mt-1">
            <b-tab :title="$t('Phone.detail')" active>
              ...
              <b-row>
                ...
                <b-col cols="2">
                  <b-form-group :label="$t('Phone.addBasket')">
                    <b-button @click="addPhoneToBasket(phoneColor.id, phoneColor.title, phoneStorage.id, phoneStorage.title, phonePrice, phonePriceVat)" type="button" variant="success" size="sm" class="float-right"><i class="fas fa-plus-square"></i></b-button>
                  </b-form-group>
                </b-col>
                <b-col cols="12">
...
export default {
  data () {
    return {
      ...
      phonePriceVat: '',
      phoneTitle: '',
      addedPhoneFields: ['colorT', 'storageT', 'price', 'kdv', 'phoneTitle', 'operation'],
      form: {
        company: '',
        type: 'cellPhone',
        brand: '',
  ...
  computed: {
    ...mapState(['dropzoneOptions', 'kdv', 'cargoPrice', 'cargoDay', 'editorJs', 'editorOption', 'returnCount', 'returnLog', 'allCompanies', 'allBrands', 'allColors', 'allStorages'])
  },
  mounted () {
    this.companies()
  ...
  methods: {
    ...
    submitPhone () {
      let phoneInfo = {
        ...
        kdv: this.form.kdv,
        cargo_price: this.cargoPrice,
        cargo_day: this.cargoDay,
        status: 1,
        line: this.form.line,
        hot: this.form.hot,
        spot: this.form.spot,
      ...
      this.$store.dispatch('createData', {...this.data, api: 'product/phone', info: phoneInfo, turn: 'Phone', retcount: 0})
    },
    companies () {
